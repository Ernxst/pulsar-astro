...
There are templates already out there, but Pulsar is a library built around a template

Pulsar uses the power of [Content Collections](https://docs.astro.build/en/guides/content-collections/)
